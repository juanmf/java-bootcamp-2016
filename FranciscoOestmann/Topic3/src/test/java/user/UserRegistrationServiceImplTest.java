...
public class UserRegistrationServiceImplTest {
	...
	public void checkIfUserHasBeenUpdated(){
		...
		user1.setLastName("Johnnz");
		userReg.updateUser(user1);
		assertTrue(userReg.getUser(user1).getFirstName().equals("Jhon"));
		assertTrue(userReg.getUser(user1).getLastName().equals("Johnnz"));
	}
	...
	public void checkIfRetrievedUserIsWantedOne(){
		...
		assertNotNull(userReg.getUser(user3));
		assertNotNull(userReg.getUser(user4));
	}
